...
public class JointsFactory {
	...
	public static Joint createPrismaticJoint(World world, Entity e1, Entity e2, Vector2 anchorE1, Vector2 anchorE2, Vector2 moveDir, float upLimit, float downLimit, float motorSpeed){
		...
		jointDef.localAxisA.set(moveDir);
		
		/*
		jointDef.enableLimit = true;
		jointDef.lowerTranslation = downLimit*GameScene.BOX_TO_WORLD;
		jointDef.upperTranslation = upLimit*GameScene.BOX_TO_WORLD;
		*/
		jointDef.enableMotor = true;
		jointDef.motorSpeed = motorSpeed;
		jointDef.maxMotorForce = 10*motorSpeed;
		
		System.out.println(jointDef.motorSpeed);
